...
def parse_args():
    ...
    path_settings.add_argument('--task', default='multi',
                               help='the task name')
    ...
    path_settings.add_argument('--preprocessed_dir', default='data/preprocessed_data/multi_task',
                               help='the dir to store prepared data')
    path_settings.add_argument('--outputs_dir', default='outputs/multi_task/',
